...
const SocketProtocol_1 = require("../../../shared/src/SocketProtocol");
...
io.on('connection', socket => {
    ...
    socket.on(SocketProtocol_1.SocketEvents.LOGIN, (payload, callback) => __awaiter(void 0, void 0, void 0, function* () {
        const result = yield socketHandlers.handleLogin(socket, payload);
        callback(result);
    }));
    socket.on(SocketProtocol_1.SocketEvents.DISCONNECT, () => __awaiter(void 0, void 0, void 0, function* () {
        yield socketHandlers.handleDisconnect(socket.id);
        console.log('User disconnected:', socket.id);
    }));
    socket.on(SocketProtocol_1.SocketEvents.JOIN_GAME, (payload, callback) => __awaiter(void 0, void 0, void 0, function* () {
        const result = yield socketHandlers.handleJoinGame(payload);
        callback(result);
    }));
    socket.on(SocketProtocol_1.SocketEvents.GAME_BUYIN, (payload, callback) => __awaiter(void 0, void 0, void 0, function* () {
        const result = yield socketHandlers.handleGameBuyin(payload);
        callback(result);
    }));
    socket.on(SocketProtocol_1.SocketEvents.PLAYER_ACTION, (payload, callback) => __awaiter(void 0, void 0, void 0, function* () {
        const result = yield socketHandlers.handlePlayerAction(payload);
        callback(result);
    }));
    socket.on(SocketProtocol_1.SocketEvents.CARDS_ARRANGEMENT, (payload, callback) => __awaiter(void 0, void 0, void 0, function* () {
        const result = yield socketHandlers.handleCardArrangement(payload);
        callback(result);
    }));
    socket.on(SocketProtocol_1.SocketEvents.LOBBY_STATUS, (callback) => __awaiter(void 0, void 0, void 0, function* () {
        const games = ServerStateManager_1.ServerStateManager.getInstance().getGames();
        const gamesList = (0, LobbyManager_1.getLobbyStatus)(games);
...
function createDummyGames(server) {
    createGame('admin', '5-10', server, (0, BettingTypes_1.getTableConfig)(10000, 10, Infinity, 10, 5, 10, 2));
    createGame('admin', '10-20', server, (0, BettingTypes_1.getTableConfig)(10000, 20, Infinity, 10, 10, 20, 3));
    createGame('admin', '25-50', server, (0, BettingTypes_1.getTableConfig)(10000, 50, Infinity, 10, 25, 50, 3));
    createGame('admin', '50-100', server, (0, BettingTypes_1.getTableConfig)(10000, 100, Infinity, 10, 50, 100, 4));
    createGame('admin', '100-200', server, (0, BettingTypes_1.getTableConfig)(10000, 200, Infinity, 10, 100, 200, 6));
}
