...
class BettingManager {
    constructor(_game, tableConfig, _onBettingRoundComplete, isPreflop) {
        ...
        if (isPreflop) {
            this._potManager.takeBlinds(_game.getPlayerInPosition(shared_1.Position.SB), _game.getPlayerInPosition(shared_1.Position.BB), tableConfig.sbAmount, tableConfig.bbAmount);
